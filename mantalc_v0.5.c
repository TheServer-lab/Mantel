/*
 * Mantel Compiler v0.5.0 - Feature Complete Edition
 * NEW: For loops, Function parameters, Better arrays, Structs, String operations
...
void gen_assign(CodeGen *cg, Node *node) {
    ...
    if (node->assign.target && node->assign.target->type == NODE_VAR) {
